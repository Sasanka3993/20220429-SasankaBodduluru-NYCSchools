package com.example.a20220429_sasankabodduluru_nycschools;
...
import com.example.a20220429_sasankabodduluru_nycschools.data.NYCSchoolContract;
import com.example.a20220429_sasankabodduluru_nycschools.model.*;
...
public class SchoolListAdapter extends RecyclerView.Adapter<SchoolListAdapter.SchoolViewHolder> {
    ...
    public interface SchoolAdapterOnClickHandler {
        void onClick(com.example.a20220429_sasankabodduluru_nycschools.model.SchoolList openAir);
    }
    //endregion
